...
public class WeatherData implements WeatherDataSubject {
	private ArrayList<WeatherDataObserver> observers;
	private float temperature;
	private float humidity;
	private float pressure;
	
	public WeatherData() {
		observers = new ArrayList<WeatherDataObserver>();
	}
	...
	public void notifyObservers() {
		for (int i = 0; i < observers.size(); i++) {
			WeatherDataObserver observer = (WeatherDataObserver)observers.get(i);
